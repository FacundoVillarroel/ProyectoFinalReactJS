...
const conVarianteNegro = new product ("conVarianteNegro","Conjunto variante negro", 1400, imgCongVarNeg,0,"Conjunto variante negro de Recreativo fútbol club","suplente");
